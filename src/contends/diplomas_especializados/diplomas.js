...
<section className="Curso-Diplomas">
    ...
    <p>
    La EMPRESA ESCUELA DE GERENCIA Y GESTIÓN desarrolla programas de capacitación y especialización orientados a ejecutivos, 
    profesionales y funcionarios que desean fortalecer y actualizar sus competencias en áreas administrativas, empresariales y 
    tecnologías de la información.
    </p>

    <p>
    Nuestros programas están diseñados para potenciar el pensamiento estratégico, la capacidad analítica y la
    resolución efectiva de problemas organizacionales, considerando los contextos nacional e internacional.
    </p>

    <p>
    Un Diploma de Especialización constituye una propuesta académica de formación continua dirigida a profesionales con 
    experiencia laboral o estudios superiores previos, que buscan profundizar conocimientos y perfeccionar habilidades en un campo 
    específico.
    </p>

    <p>
    La certificación se otorga a quienes culminen satisfactoriamente el plan de estudios, acreditando competencias técnicas avanzadas 
    y especializadas.
    </p>
